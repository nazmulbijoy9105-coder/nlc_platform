...
from .enums import AiModel, DocumentType, EventAction
...
class Document(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    financial_year: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    ai_model_used: Mapped[Optional[AiModel]] = mapped_column(
        Enum(AiModel, name="ai_model"), nullable=True
    )
    ai_output_log_id: Mapped[Optional[uuid.UUID]] = mapped_column(
    ...
    client_released_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
...
class AIPromptTemplate(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    output_format_instructions: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True
    )
    required_placeholders: Mapped[Optional[list]] = mapped_column(
        JSONB, nullable=True,
