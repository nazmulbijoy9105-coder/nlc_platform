...
def _create_companies() -> None:
    op.create_table(
        ...
        sa.Column("company_type",           postgresql.ENUM(name="company_type", create_type=False), nullable=False),
        sa.Column("company_status",         postgresql.ENUM(name="company_status", create_type=False),
                  server_default="ACTIVE", nullable=False),
        sa.Column("lifecycle_stage",        postgresql.ENUM(name="lifecycle_stage", create_type=False),
        ...
        sa.Column("current_risk_band",      postgresql.ENUM(name="risk_band", create_type=False), nullable=True),
        sa.Column("current_exposure_band",  postgresql.ENUM(name="exposure_band", create_type=False), nullable=True),
        ...
        sa.Column("revenue_tier",           postgresql.ENUM(name="revenue_tier", create_type=False), nullable=True),
...
def _create_directors() -> None:
    op.create_table(
        ...
        sa.Column("director_status", postgresql.ENUM(name="director_status", create_type=False),
                  server_default="ACTIVE", nullable=False),
...
def _create_share_transfers() -> None:
    op.create_table(
        ...
        sa.Column("transfer_status", postgresql.ENUM(name="transfer_status", create_type=False),
...
def _create_compliance_events() -> None:
    op.create_table(
        ...
        sa.Column("action",        postgresql.ENUM(name="event_action", create_type=False), nullable=False),
...
def _create_compliance_flags() -> None:
    op.create_table(
        ...
        sa.Column("exposure_band",   postgresql.ENUM(name="exposure_band", create_type=False), nullable=True),
        sa.Column("revenue_tier",    postgresql.ENUM(name="revenue_tier", create_type=False), nullable=False),
        sa.Column("flag_status",     postgresql.ENUM(name="flag_status", create_type=False),
                  server_default="ACTIVE", nullable=False),
...
def _create_legal_rules() -> None:
    op.create_table(
        ...
        sa.Column("default_severity",    postgresql.ENUM(name="severity_level", create_type=False), nullable=False),
        sa.Column("score_impact",        sa.Integer, nullable=False, server_default="0"),
        sa.Column("revenue_tier",        postgresql.ENUM(name="revenue_tier", create_type=False), nullable=False),
...
def _create_rescue_steps() -> None:
    op.create_table(
        ...
        sa.Column("complexity",  postgresql.ENUM(name="complexity_level", create_type=False),
        ...
        sa.Column("target_completion_date", sa.Date, nullable=True),
        sa.Column("step_status",  postgresql.ENUM(name="rescue_step_status", create_type=False),
...
def _create_tasks() -> None:
    op.create_table(
        ...
        sa.Column("task_status",   postgresql.ENUM(name="task_status", create_type=False),
                  server_default="PENDING", nullable=False),
        sa.Column("priority",      postgresql.ENUM(name="task_priority", create_type=False),
                  server_default="MEDIUM", nullable=False),
...
def _create_engagements() -> None:
    op.create_table(
        ...
        sa.Column("engagement_status", postgresql.ENUM(name="engagement_status", create_type=False),
...
def _create_documents() -> None:
    op.create_table(
        ...
        sa.Column("ai_model_used",     postgresql.ENUM(name="ai_model", create_type=False), nullable=True),
...
def _create_notifications() -> None:
    op.create_table(
        ...
        sa.Column("notification_status",    postgresql.ENUM(name="notification_status", create_type=False),
                  server_default="PENDING", nullable=False),
...
def _create_sro_registry() -> None:
    op.create_table(
        ...
        sa.Column("sro_type",           postgresql.ENUM(name="sro_type", create_type=False), nullable=False),
...
def _create_ai_output_log() -> None:
    op.create_table(
        ...
        sa.Column("document_type",  postgresql.ENUM(name="document_type", create_type=False), nullable=True),
        sa.Column("ai_model",       postgresql.ENUM(name="ai_model", create_type=False), nullable=False),
